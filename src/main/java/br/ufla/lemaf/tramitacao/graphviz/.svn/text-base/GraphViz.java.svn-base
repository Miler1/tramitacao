...
{
	public static final String OUTPUT_TYPE = "jpg";
	/**
	 ...
	 */
  private static String TEMP_DIR = GraphVizProperties.getProperty("tempDirFor" + osName);
			
	/**
	 * Where is your dot program located? It will be called externally.
	 */
  private static String DOT = GraphVizProperties.getProperty("dotFor" + osName);
